...
**Answer:** Yes, our beta 1 coefficient is biased due to OVB. By omitting V2, our beta 1 coefficient has upward bias (larger than it would be with V2 in the model: 7.87 vs 3.045). 
...
```{r}
library(stargazer)
visual1 <- stargazer(M2, M3, type="latex", header=FALSE, title="OVB vs No OVB", 
                     style="qje", 
